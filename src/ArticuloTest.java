...
public class ArticuloTest {
	...
	public void noHayArticulo(){
		...
		assertEquals(0,articulo.calcularTotalArticulo(),0.01);
	...
	public void calcularArticulo(){
		...
		assertEquals(12,articulo.calcularTotalArticulo(),0.01);
	...
	public void calcularArticuloConDecimal(){
		...
		assertEquals(14,articulo.calcularTotalArticulo(),0.01);
